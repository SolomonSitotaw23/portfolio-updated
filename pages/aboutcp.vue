    ...
    <section class="section !bg-white_ animate-fade-in">
        ...
        >
            ...
            <div class="flex flex-col gap-4 justify-center h-full py-12">
                <span class="md:text-base text-sm w-1/2"
                    >Fullstack developer
                </span>
        ...
        <!-- right side -->
        <div class="lg:w-1/2 py-20 lg:px-8 px-4 h-screen overflow-scroll">
            <div v-for="about in abouts" class="">
                <div
                    class="h-full w-full relative flex items-start justify-start flex-col md:gap-16 gap-12"
                >
                    <h1
