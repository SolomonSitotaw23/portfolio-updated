...
<template>
  <section class="section">
    ...
    <!-- right side -->
    <div
      class="lg:border-8 bg-white_ border-white_border border-l-0 lg:w-1/2 lg:py-20 px-4 max-h-screen overflow-hidden sm:scrollbar-custom"
    >
      <div
        class="lg:px-20 lg:h-[80vh] h-screen overflow-scroll w-full flex flex-col gap-6 sm:scrollbar-custom scroll-smooth"
      >
        <div v-for="(about, index) in abouts" :key="index" class="">
          <div
