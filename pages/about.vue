...
<template>
  <section class="section !bg-white_">
    <div
      class="lg:w-1/2 text-white_ font-space-grotesk bg-primary_custom lg:border-8 border-r-0 border-primary_border lg:py-24 lg:px-20 px-8 flex flex-col gap-4"
    >
      <!-- Back button mobile -->
      <NuxtLink
        to="/"
      ...
      <div class="flex flex-col gap-4 justify-center h-full py-12">
        ...
        <p class="md:text-lg text-sm">
          I'm Solomon, a multi-award winning product designer based in Dembia.
          During my career I've had the privilege of creating experiences for
          clients including the New York Times and Google. I've also helped
          guide teams at Facebook and startups like Highfive and WeTransfer.
        </p>
        <!-- Skills Gained -->
      </div>
    </div>
    ...
    <div
      class="lg:w-1/2 md:min-h-full py-20 flex items-center justify-center md:px-20 bg-white_ lg:border-8 border-white_border border-l-0 md:py-20 px-8"
    >
      <div
