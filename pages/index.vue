  ...
  >
    ...
    >
      ...
      <div class="flex flex-col items-center justify-center w-full">
        <div
          class="lg:rounded-full h-[60dvh] md:h-[500px] w-full lg:w-[500px] bg-[#002DB3] drop-shadow-glow self-center items-center md:justify-center flex flex-col py-16 lg:absolute"
        >
          ...
          <div class="flex flex-col relative items-center">
            ...
            <span
              class="2xl:text-[13rem] xl:text-[10rem] md:text-[5rem] text-[3rem] font-baunk text-white_"
            >
              Solomon
            </span>
            <div
        ...
        <div class="w-1/3 flex items-center justify-center">
          <NuxtImg
            src="image/me.png"
            class="2xl:w-1/3 md:w-1/2 xl:w-[40%] lg:w-[40%] md:block absolute -bottom-24"
            alt=""
          />
          <div
      ...
      <div>
        <button
          class="contact_button absolute hidden md:bottom-5 md:right-20 md:flex items-center justify-center z-50"
          @click="openModal()"
        >
          <Icon
            name="f7:chat-bubble-2-fill"
